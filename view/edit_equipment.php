 ...
 if (isset($_SESSION['valid']) == true) {
    ...
    if(isset($_SESSION['equipment_edit']) == true && $_SESSION['equipmentId'] != null){
        ...
        foreach ($assets as $asset) {
            ...
            $propertyName       = $asset['propertyId'];
            $floor              = $asset['floor'];
            $location           = $asset['location'];
            $emplacement        = $asset['emplacement'];
            $assetName          = $asset['assetName'];
            $buildingComponent  = $asset['buildingComponent'];
           ...
           $lastMaintenanceDate = $asset['lastMaintenanceDate'];
            ...
            $maintenanceRep     = $asset['maintenanceRep'];
            $maintenanceRepDate = $asset['maintenanceRepDate'];
            $notes              = $asset['notes'];
            $status             = $asset['status'];
